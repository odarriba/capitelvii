Rails.application.configure do
  ...
  Rails.application.routes.default_url_options = { host: 'www.capitelvii.com', :protocol => 'https' }

  # Ignore bad email addresses and do not raise email delivery errors.
  # Set this to true and configure the email server for immediate delivery to raise delivery errors.
  # config.action_mailer.raise_delivery_errors = false
  config.action_mailer.default_url_options = { host: 'www.capitelvii.com', :protocol => 'https' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address:              Rails.application.secrets.smtp['server'],
    port:                 Rails.application.secrets.smtp['port'].to_i,
